...
-- ============================================================
-- 1. PRIME AI 内嵌菜单
--    在 RuoYi 布局内通过 iframe 打开 PRIME AI（服务器 172.16.16.110:3305）
-- ============================================================
...
(1805000, 'PRIME AI', 0, 7, 'http://172.16.16.110:3305', NULL, NULL, 'N', 'N', 'M', '0', '0', NULL, 'ep:chat-dot-round', NULL, NULL, NULL, @admin_id, sysdate(), NULL, NULL, 'PRIME AI 内嵌打开');
