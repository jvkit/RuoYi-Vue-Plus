...
public class PmsPurchaseOrderController extends BaseController {
    ...
    @GetMapping("/list")
    public TableDataInfo<PmsPurchaseOrderVo> list(@Validated(QueryGroup.class) PmsPurchaseOrderBo bo, PageQuery pageQuery) {
    ...
    public void export(@Validated PmsPurchaseOrderBo bo, HttpServletResponse response) {
        ...
        ExcelUtil.exportExcel(list, "采购订单", PmsPurchaseOrderVo.class, response);
    }
