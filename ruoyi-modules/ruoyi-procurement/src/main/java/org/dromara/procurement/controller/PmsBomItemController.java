...
public class PmsBomItemController extends BaseController {
    ...
    @GetMapping("/list")
    public R<PageResult<PmsBomItemVo>> list(@Validated(QueryGroup.class) PmsBomItemBo bo, PageQuery pageQuery) {
        return R.ok(bomItemService.queryPageList(bo, pageQuery));
    }
    ...
    public void export(@Validated PmsBomItemBo bo, HttpServletResponse response) {
        ...
        ExcelBuilder.of(list, PmsBomItemVo.class).sheetName("采购BOM").toResponse(response);
    }
