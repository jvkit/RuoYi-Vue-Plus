...
public class InvoiceUsageRecordController extends BaseController {
    ...
    @GetMapping("/list")
    public PageResult<InvoiceUsageRecordVo> list(InvoiceUsageRecordBo bo, PageQuery pageQuery) {
    ...
    public void export(InvoiceUsageRecordBo bo, HttpServletResponse response) {
        ...
        ExcelBuilder.of(list, InvoiceUsageRecordVo.class).sheetName("发票使用记录").toResponse(response);
    }
