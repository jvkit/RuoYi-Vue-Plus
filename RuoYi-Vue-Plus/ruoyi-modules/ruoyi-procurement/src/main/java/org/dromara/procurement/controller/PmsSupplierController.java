...
public class PmsSupplierController extends BaseController {
    ...
    @GetMapping("/list")
    public TableDataInfo<PmsSupplierVo> list(@Validated(QueryGroup.class) PmsSupplierBo bo, PageQuery pageQuery) {
    ...
    public void export(@Validated PmsSupplierBo bo, HttpServletResponse response) {
        ...
        ExcelUtil.exportExcel(list, "采购供应商", PmsSupplierVo.class, response);
    }
