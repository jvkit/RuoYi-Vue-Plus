...
public class PmsProcurementRequestController extends BaseController {
    ...
    @GetMapping("/list")
    public TableDataInfo<PmsProcurementRequestVo> list(@Validated(QueryGroup.class) PmsProcurementRequestBo bo, PageQuery pageQuery) {
        return requestService.queryPageList(bo, pageQuery);
    }
    ...
    public void export(@Validated PmsProcurementRequestBo bo, HttpServletResponse response) {
        ...
        ExcelUtil.exportExcel(list, "采购申请", PmsProcurementRequestVo.class, response);
    }
