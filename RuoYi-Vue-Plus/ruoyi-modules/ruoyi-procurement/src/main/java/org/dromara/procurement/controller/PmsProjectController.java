...
public class PmsProjectController extends BaseController {
    ...
    @GetMapping("/list")
    public TableDataInfo<PmsProjectVo> list(@Validated(QueryGroup.class) PmsProjectBo bo, PageQuery pageQuery) {
    ...
    public void export(@Validated PmsProjectBo bo, HttpServletResponse response) {
        ...
        ExcelUtil.exportExcel(list, "采购项目", PmsProjectVo.class, response);
    }
